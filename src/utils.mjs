...
const playAlert = (volume) => {
    ...
    let timer = setInterval(sound, 1000);
    sound();
    setTimeout(function (){
        clearInterval(timer);
    }, 3500)
